...
export default class UserProfile extends React.Component {
    ...
    graphMeditateValue(){
        ...
        {
            meditated=this.state.totalGoalAchieved;
            //alert("Goal Achived")
        }
        return meditated;
    }
    graphNotMeditatedValue(){
        ...
        //alert("You still have to meditate", `${notMeditated}`, "minutes to achive the goal" );
        }
        return notMeditated;
    }
  ...
  <DonutChart
    data={[{
        label: 'Meditated',
        value: {this:this.graphMeditateValue()}
    },
    {
        label: 'Not Meditated',
        value: {this:this.graphNotMeditatedValue()}
